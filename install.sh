...
#Welcome to AutoUpdater6.0 Installer (Debian/Ubuntu)
...
zenity --info --text="Welcome to AutoUpdater6.0 Installer"
opt=$(zenity --entry --text "Enter old for older versions of Ubuntu and other for others" --title="AutoUpdater6.0 Installer")
if [ $opt = "old" ]; then
